...
<style type='text/css'>
   ...
   .wrap { word-wrap:break-word; /* use up entire cell this div is contained in? */ }
										...
										<div>
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												<thead>
													<tr>
														<th>أسم النيابة</th>
														<th>النيابة الكلية</th>
														<th>الأقسام التابع لها</th>
													</tr>
												</thead>
												...
												<?php 
													...
													?>
													<tr>
														<td><a class="green" href="prosprofile.php?idpros=<?php echo $row4['idpros'] ?>"><?php echo $row4['prosname'] ?></a></td>
														<td>
														...
														<td>
															...
															<?php
																...
																while($row = mysqli_fetch_assoc($matresult))
																	{	
																	$prosid= $row['iddeparts'];
																	$prosname= $row['departname'];
																	echo '<a  class="btn btn-xs btn-'.$color.'">';
																	echo $prosname;
																	echo '</a>'."&nbsp;&nbsp;&nbsp;";
																};
								...
								<div id="modal-add2" class="modal fade" tabindex="-1">
									<div class="modal-dialog">
										<div class="modal-content">
											<div class="modal-header no-padding">
												<div class="table-header">
											...
											<form class="form-horizontal" method="post" action="assets/redi/insertdepart.php">
												...
												<div class="form-group">
													<label class="col-sm-3 control-label no-padding-right" for="form-field-13">يتبع نيابة</label>
													<div class="col-sm-8">
														<select name="prosid" >
															<?php
