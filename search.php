								...
								<div class="row">
									...
									<div class="col-xs-12">
										<div class="clearfix">
											...
											} elseif (!empty($casenum) && empty($year))
											{
												$result = mysqli_query($sqlcon, "Select `case`.casenum,
																				  `case`.idcase,
																				  `case`.caseyear,
											...
											} elseif (empty($casenum) && empty($year))
											{
												$result = mysqli_query($sqlcon, "Select `case`.casenum,
																				  ...
																				  Inner Join sarki On `case`.sarki_idsarki = sarki.idsarki
																				  Inner Join users On users.idusers = sarki.idusers
																			Where casetype.idcasetype = $type And departs.iddeparts = $depart");
											} else 
											{
												$result = mysqli_query($sqlcon, "Select `case`.casenum,
																				  `case`.idcase,
																				  ...
																				  Inner Join sarki On `case`.sarki_idsarki = sarki.idsarki
																				  Inner Join users On users.idusers = sarki.idusers 
																			Where `case`.casenum = $casenum And `case`.caseyear = $year And casetype.idcasetype = $type And departs.iddeparts = $depart");
											}
											...
											<div class="form-group">
												...
												<div class="col-sm-8">
													<input type="text" class="input-sm" id="spinner5" name="casenum"/>
												</div>
												<br>
												<br>
												<label class="col-sm-1 control-label no-padding-right" for="form-field-4"> سنة القضية </label>
												<div class="col-sm-8">
													<input type="text" class="input-sm" id="spinner5" name="year"/>
												</div>
												<br>
												<br>
												<label class="col-sm-1 control-label no-padding-right" for="form-field-4"> الجدول </label>
												<div class="col-sm-8" required>
													<select required="required" id="form-field-4" name="type">
														<option selected="selected" value="" disabled>--إختار الجدول--</option>
														<?php
												...
												<div class="col-sm-8">
													<select required="required" id="form-field-4" name="depart">
														<?php 
