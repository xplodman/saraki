...
<div id="main-wrapper">
    ...
    <div class="page-wrapper">
        ...
        <div class="container-fluid">
            ...
            <?php
            $group_query="SELECT `group`.group_id, `group`.group_name FROM `group`";?>
            <!-- Start Page Content -->
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="table-responsive">
                                <table id="datatable" class="display table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                    ...
                                    while($group_info = mysqli_fetch_assoc($result)) {
                                        ?>
                                        <tr data-child-value="<?php
                                        ?>">
                                            <td>
                                                <?php echo $group_info['group_id']?>
                                            </td>
                                            <td>
                                                <?php echo $group_info['group_name']?>
                                            </td>
                                            <td>
                                                <a href="group_profile.php?group_id=<?php echo $group_info['group_id'] ?>">
                                                    <button type="button" class="btn waves-effect waves-light btn-info">
                                                        Edit
                                                    </button>
                                                </a>
                                                <a href="group_profile.php?group_id=<?php echo $group_info['group_id'] ?>">
                                                    <button type="button" class="btn waves-effect waves-light btn-danger test" data-cid="group_id=<?php echo $group_info['group_id'] ?>" id="sa-warning">
                                                        Delete
                                                    </button>
                                                </a>
                                            </td>
            ...
            function LikeComment(id){
                swal({
                    ...
                    swal({
                        ...
                        function(){
                            window.location.href = "php/delete_group.php?"+id;
                        })
                });
            }
        },
