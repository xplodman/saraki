...
<div id="main-wrapper">
    ...
    <div class="page-wrapper">
        ...
        <div class="container-fluid">
            ...
            <?php
            $issue_query="SELECT `issue`.issue_id, `issue`.issue_name FROM `issue`";?>
            <!-- Start Page Content -->
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="table-responsive">
                                <table id="datatable" class="display table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                    ...
                                    while($issue_info = mysqli_fetch_assoc($result)) {
                                        ?>
                                        <tr data-child-value="<?php
                                        ?>">
                                            <td>
                                                <?php echo $issue_info['issue_id']?>
                                            </td>
                                            <td>
                                                <?php echo $issue_info['issue_name']?>
                                            </td>
                                            <td>
                                                <a href="issue_profile.php?issue_id=<?php echo $issue_info['issue_id'] ?>">
                                                    <button type="button" class="btn waves-effect waves-light btn-info">
                                                        Edit
                                                    </button>
                                                </a>
                                                <a href="issue_profile.php?issue_id=<?php echo $issue_info['issue_id'] ?>">
                                                    <button type="button" class="btn waves-effect waves-light btn-danger test" data-cid="issue_id=<?php echo $issue_info['issue_id'] ?>" id="sa-warning">
                                                        Delete
                                                    </button>
                                                </a>
                                            </td>
    ...
    $(document).ready(function() {
        $('#datatable').DataTable({
            initComplete: function () {
                this.api().columns(':eq(6)').every( function () {
                    var column = this;
            ...
            function LikeComment(id){
                swal({
                    ...
                    swal({
                        ...
                        function(){
                            window.location.href = "php/delete_issue.php?"+id;
                        })
                });
            }
        },
