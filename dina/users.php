...
<div id="main-wrapper">
    ...
    <div class="page-wrapper">
        ...
        <div class="container-fluid">
            ...
            <?php
            $user_query="SELECT `user`.user_id, `user`.user_name, `user`.user_phone_num FROM `user`";?>
            <!-- Start Page Content -->
            <div class="row">
                <div class="col-12">
                    <div class="card">
                                ...
                                <table id="datatable" class="display table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                    ...
                                    while($user_info = mysqli_fetch_assoc($result)) {
                                        ...
                                        ?>">
                                            ...
                                            <td>
                                                <?php echo $user_info['user_phone_num']?>
                                            </td>
                                            <td>
                                                <a href="user_profile.php?user_id=<?php echo $user_info['user_id'] ?>">
                                                    <button type="button" class="btn waves-effect waves-light btn-info">
                                                        Edit
                                                    </button>
                                                </a>
                                                <a href="user_profile.php?user_id=<?php echo $user_info['user_id'] ?>">
                                                    <button type="button" class="btn waves-effect waves-light btn-danger test" data-cid="user_id=<?php echo $user_info['user_id'] ?>" id="sa-warning">
                                                        Delete
                                                    </button>
                                                </a>
                                            </td>
            ...
            function LikeComment(id){
                swal({
                    ...
                    swal({
                        ...
                        function(){
                            window.location.href = "php/delete_user.php?"+id;
                        })
                });
            }
        },
