												...
												if (isset($_SESSION['securitylvl']))
													{
														...
														if($securitylvl == "d" || $securitylvl == "a" ):
															?>
																	...
																	<a href="#add_cj_data" class="btn btn-white btn-info btn-bold" data-toggle="modal">
											...
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												<thead>
													<tr>
														...
														<th>password</th>
														<th>national id</th>
														<th>prosecution type</th>
														<th>In prosecution</th>
													</tr>
												</thead>
...
ORDER BY
  cj_data.pros_type,
  cj_data.pros_idpros,
  cj_data.overallpros_overallprosid");
												}
												while($row4 = mysqli_fetch_assoc($result4))
													...
													<tr>
														<td>
															<a class="red" href="cj_data_profile.php?cj_data_id=<?php echo $row4['id'] ?>"><?php echo $row4['name'] ?></a>
														</td>
														<td><?php echo $row4['job'] ?></td>
								...
								<div id="add_cj_data" class="modal fade" tabindex="-1">
									<div class="modal-dialog">
										<div class="modal-content">
											...
											<form class="form-horizontal" method="post" action="assets/redi/insert_cj_data.php">
												<div class="form-group">
													<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> nickname </label>
													<div class="col-sm-9">
														<input required type="text" id="form-field-1" placeholder="nickname" class="col-xs-10 col-sm-5" name="nickname"/>
													</div>
												</div>
												<div class="form-group">
													<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Job </label>
													<div class="col-sm-9">
														<input required type="text" id="form-field-1" placeholder="job" class="col-xs-10 col-sm-5" name="job"/>
													</div>
												</div>
												<div class="form-group">
												...
												<div class="form-group">
													...
													<div class="col-sm-9">
														<input type="text" id="form-field-1" placeholder="national_id" class="col-xs-10 col-sm-5"  name="national_id"/>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-sm-8">
														<div class="input-group">
															<input type="radio" name='Prosecution_radio' value='1' id="Prosecution_radio"> Prosecution </input>
														</div>
														<div class="input-group">
															<input type="radio" name='Prosecution_radio' value='2' id="over_all_Prosecution_radio" > Over all prosecution </input>
														</div>
													</div>
												</div>
												
												<div class="hidden form-group" id="Prosecution">
...
WHERE
  overallpros_has_users.users_idusers = '$admin_id'");
												...
												<div class="hidden form-group" id="over_all_Prosecution">
...
WHERE
  overallpros_has_users.users_idusers = '$admin_id'");
																...
																?>
																<option value="<?php echo $row2['overallprosid'] ?>"> <?php echo $row2['overallprosname'] ?> </option>
															<?php } ?>
														</select>
													</div>
												</div>
