			...
			<div class="main-content">
				<div class="main-content-inner">
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
							<h3>إجمالي القضايا المدخلة لجميع النيابات من سبعة شهور حتى الأن</h3>
									...
									<?php
										...
										if($securitylvl == "a")
										{
												...
												Where Month(`case`.createdate) = $month
												") or die(mysqli_error($sqlcon));
													while($row4 = mysqli_fetch_assoc($result4))
														{
														?>
															<tr>
																<td><?php echo $row4['Count(`case`.idcase)'] ?></td>
																<td><?php
 																$lastmonth = date("$month , Y");
																if($month >= 1 && $month <= 12){
																	//The month is valid.
								...
								<div class="row">
									...
									<?php
												...
												$month = $month-$i;
																...
																//out onto the page.
																?>
																	<a   target="_blank" href="monthlyrep.php?monthnum=<?php echo $month ?>" >
																		<button class="btn btn-info" >
																		<?php echo "(".$text.") ".$lastmonth." تقرير شهر "; ?>
																		</button>
																	</a>																	
														<?php
													};
								...
								<div class="row">
									<div class="col-sm-4">
										<h3>كشف بعدد القضايا المدخلة لكل نيابة</h3>
										<div class="widget-box">
											<div class="widget-header">
												...
												<div class="pull-LEFT">
													<h4 class="smaller">
														إحصائية <small>بعدد القضايا المدخله شهرياً</small>
													</h4>
												</div>
											</div>
													...
													<?php
														...
														for($u=0 ; $u > -3; $u--){
															...
															Select Count(`case`.departs_iddeparts) As countcase,
															  departs.departname As departname,
															  `case`.createdate As createdate,
															  departs.iddeparts As iddeparts,
															  departs.pros_idpros As prosid,
															...
															Group By  departs.iddeparts,MONTH(`case`.createdate)
															Having MONTH(createdate) = MONTH(DATE_SUB(curdate(), INTERVAL $i MONTH)) AND YEAR(createdate) = 2017
															Order By `case`.caseyear Desc,
															  departs.iddeparts,
															  casetype.idcasetype,
															  users.nickname") or die(mysqli_error($sqlcon));
															  $i++;
																while($row4 = mysqli_fetch_assoc($result4))
																	{
																		...
																		<tr>
																			...
																			<td><a class="green" href="prosprofile.php?idpros=<?php echo $row4['prosid'] ?>"><?php echo $row4['prosname'] ?></a></td>
																			<td><?php echo date('Y-m (M)',strtotime("$u months"));?></td>
																		</tr>
																		<?php
																	};
															};
										...
										<div class="widget-box">
											<div class="widget-header">
												<div class="pull-right">
													<div class="tableTools-container3"></div>
												</div>
												<div class="pull-LEFT">
													<h4 class="smaller">
