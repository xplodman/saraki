                    ...
                    if ($backresult ==  "1") {
                        ...
                        <div class="alert alert-block alert-danger">
                            ...
                            <strong class="red">
                                ...
                                <br>
                                <?php
                                $failed_in_investigation_case_number = $_SESSION["failed_in_investigation_case_number"];
                                $failed_in_investigation_case_year = $_SESSION["failed_in_investigation_case_year"];
                                $failed_in_investigation_case_type = $_SESSION["failed_in_investigation_case_type"];
                                $failed_in_investigation_case_depart = $_SESSION["failed_in_investigation_case_depart"];
                                $case_failed_count = sizeof($failed_in_investigation_case_number);
                                echo "هناك مشكلة في إضافة الحصر على الأرقام التالية";
                                for($len=0 ; $len < $case_failed_count ; $len++)
                                {
                                    echo "<br>".$failed_in_investigation_case_number[$len]." / ".$failed_in_investigation_case_year[$len]." ".$failed_in_investigation_case_type[$len]." ".$failed_in_investigation_case_depart[$len];
                                }
                                unset($_SESSION['failed_in_investigation_case_number']);
                                unset($_SESSION['failed_in_investigation_case_year']);
                                unset($_SESSION['failed_in_investigation_case_type']);
                                unset($_SESSION['failed_in_investigation_case_depart']);
                                ?>
                            </strong>
                        </div>
                        <?php
                        ...
                        <div class="alert alert-block alert-danger">
                            ...
                            <strong class="red">
                                ...
                                echo "هناك مشكلة في إضافة الحصر على الأرقام التالية لكونها غير مدرجة بالنظام";
                                for($len=0 ; $len < $case_failed_count ; $len++)
                                {
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        if($_SESSION['securitylvl'] == "a")
                        {
                            ...
                            $case_has_investigation_query="
SELECT
  case_has_investigation.investigation_number,
  case_has_investigation.investigation_year,
  case_has_investigation.scanned,
  case_has_investigation.id_case_has_investigation,
  Date_Format(`case_has_investigation`.insert_date, '%d/%m/%Y, %l:%i %p') AS createdate ,
  Date_Format(`case_has_investigation`.update_date, '%d/%m/%Y, %l:%i %p') AS update_date ,
  casetype.casetypename,
  departs.departname,
  `case`.casenum,
  `case_has_investigation`.`case_idcase`,
  `case`.caseyear,
  users.idusers,
  users.nickname
FROM
  case_has_investigation
  INNER JOIN `case` ON case_has_investigation.case_idcase = `case`.idcase
  ...
  INNER JOIN users ON case_has_investigation.users_idusers = users.idusers
WHERE
  case_has_investigation.status = 1 AND
  case_has_investigation.remove = 0 AND
...
WHERE
  case_has_investigation.status = 1 AND
  case_has_investigation.remove = 0 AND
  users.idusers =$_SESSION[idusers]
";
                        }
                        $case_has_investigation_query .= " ORDER BY case_has_investigation.id_case_has_investigation DESC";
                        $case_has_investigation_query .= " Limit 500";
                        ?>
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="clearfix">
                                    ...
                                    if (isset($_SESSION['securitylvl']))
                                    {
                                        ...
                                        if($securitylvl == "d" ):
                                            ?>
                                            <a href="#add_investigation" class="btn btn-warning btn-bold" data-toggle="modal">
                                                <i class="ace-icon fa fa-plus-square-o"></i>
                                                <b>إضافة حصر تحقيق</b></font>
                                            </a>
                                            <a href="#update_investigation" class="btn btn-success btn-bold" data-toggle="modal">
                                                <i class="ace-icon fa fa-plus-square-o"></i>
                                                <b>إضافة إرفاق لقضية تم حصرها مسبقاً</b></font>
                                            </a>
                                            <?php
                                        endif;
                                    }
                                ...
                                <div>
                                    <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                        ...
                                        <tbody>
                                        <?php
                                        $case_has_investigation_query_result = mysqli_query($sqlcon, $case_has_investigation_query);
                                        while($case_has_investigation_query_info = mysqli_fetch_assoc($case_has_investigation_query_result))
                                        {

                                            ?>
                                            <tr>
                                                <td><span  class="text-warning"> <?php echo $case_has_investigation_query_info['id_case_has_investigation'] ?> </span ></td>
                                                <td><span  class="text-warning"> <?php echo $case_has_investigation_query_info['casenum'] ?> </span > / <span  class="text-info"> <?php echo $case_has_investigation_query_info['caseyear'] ?> </span > - <span  class="text-success"> <?php echo $case_has_investigation_query_info['departname'] ?> </span > - <span  class="text-danger"> <?php echo $case_has_investigation_query_info['casetypename'] ?> </span ></td>
                                                <td>
                                                    <?php echo $case_has_investigation_query_info['investigation_year'] ?> </span > / <span  class="text-info"> <?php echo $case_has_investigation_query_info['investigation_number'] ?>
                                                </td>
                                                <?php if($_SESSION['securitylvl'] == "a"){?>
                                                    <td><a class="green" href="userprofile.php?idusers=<?php echo $case_has_investigation_query_info['idusers'] ?>"><?php echo $case_has_investigation_query_info['nickname'] ?></a></td>
                                                <?php }else{?>
                                                    <td><?php echo $case_has_investigation_query_info['nickname'] ?></td>
                                                <?php };?>
                                                <td><?php echo $case_has_investigation_query_info['createdate'] ?></td>
                                                <td><?php echo $case_has_investigation_query_info['update_date'] ?></td>
                                                <td>
                                                    <?php
                                                    if($case_has_investigation_query_info['scanned'] == '1'){
                                                        ?>
                                                        <a  class="btn btn-success" data-toggle="modal">
                                                            <b>تم المسح الضوئي</b></font>
                                                        </a>
                                                    <?php
                                                    }else{
                                                        ?>
                                                        <a  class="btn btn-danger" data-toggle="modal">
                                                            <b>لم يتم المسح الضوئي</b></font>
                                                        </a>
                                                    <?php                                                    }
                                                    ?>
                        ...
                        <div id="add_investigation" class="modal fade" tabindex="-1">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form class="form-horizontal" method="post" action="assets/redi/insert_investigation.php">
                                                ...
                                                <div class="multi-field-wrapper">
                                                    <div class="multi-fields">
                                                        <div class="multi-field">
                                                            ...
                                                            <br>
                                                            <input required type="number" class="input-sm" id="investigation_number" name="investigation_number[]" placeholder="رقم الحصر"/>
                                                            <input required type="number" class="input-sm" id="investigation_year" name="investigation_year[]" placeholder="سنة الحصر"/>
                        ...
                        <div id="update_investigation" class="modal fade" tabindex="-1">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header no-padding">
                                        <div class="table-header">
                                            ...
                                            إضافة إرفاق لقضايا تم حضرها مسبقاً
                                        </div>
                                    </div>
                                    <form class="form-horizontal" method="post" action="assets/redi/update_investigation.php">
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label no-padding-right" for="form-field-8"> أرقام الحصر </label>
                                            <div class="col-sm-8">
                                                <div class="multi-field-wrapper">
                                                    <div class="multi-fields">
                                                        <div class="multi-field">
                                                            <input required type="number" class="input-sm col-xs-2" id="investigation_number" name="investigation_number[]" placeholder="رقم الحصر"/>
                                                            <input required type="number" class="input-sm col-xs-2" id="investigation_year" name="investigation_year[]" placeholder="سنة الحصر"/>
                                                            <select required id="form-field-4" name="investigation_depart[]">
                                                                <?php
                                                                if($_SESSION['securitylvl'] == "a")
                                                                {
                                                                    $result2 = mysqli_query($sqlcon, "Select
