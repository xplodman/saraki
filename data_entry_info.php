                                ...
                                <div id="user-profile-1" class="user-profile row">
                                    <div class="profile-user-info profile-user-info-striped">
										...
										<div class="profile-info-row">
											<div class="profile-info-name">الرقم القومي</div>
											<div class="profile-info-value">
												<input required type="text" class="form-control" name="national_id" >
											</div>
										</div>
										<div class="profile-info-row">
											<div class="profile-info-name">الأسم رباعي</div>
											<div class="profile-info-value">
												<input required type="text" class="form-control" name="nickname" >
											</div>
										</div>
										<div class="profile-info-row">
											<div class="profile-info-name">رقم الموبايل</div>
											<div class="profile-info-value">
												<input required type="text" class="form-control" name="mob_number" >
											</div>
										</div>
										<?php
										}
										...
										<div class="profile-info-row">
											...
											<div class="profile-info-value">
												...
												<input required name="rest_day" class="" type="radio" value="Saturday">
												<label class="checkbox-inline">
													الأحد
												</label>
												<input required name="rest_day" class="" type="radio" value="Sunday">
												<label class="checkbox-inline">
													الإثنين
												</label>
												<input required name="rest_day" class="" type="radio" value="Monday">
												<label class="checkbox-inline">
													الثلاثاء
												</label>
												<input required name="rest_day" class="" type="radio" value="Tuesday">
												<label class="checkbox-inline">
													الأربعاء
												</label>
												<input required name="rest_day" class="" type="radio" value="Wednesday">
												<label class="checkbox-inline">
													الخميس
												</label>
												<input required name="rest_day" class="" type="radio" value="Thursday">
											</div>
										</div>
										<?php
										if(1==2){
