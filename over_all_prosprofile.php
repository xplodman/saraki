					...
					<div class="page-content">
							...
							if (isset($_GET['backresult']))
						{
							...
							if ($backresult ==  "1") {
								...
								$over_all_id_pros=$_GET['over_all_id'];
								...
								FROM
								  overallpros
								WHERE
								  overallpros.overallprosid = '$over_all_id_pros'");
								  
								while($over_all_pros_info_res = mysqli_fetch_assoc($result))
														{	
													?>								
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<div>
									<form method="post" action="assets/redi/edit_over_all_pros.php?id_over_all_pros=<?php echo $over_all_id_pros?>" method="post">
												...
												<div class="profile-user-info profile-user-info-striped">
													<div class="profile-info-row">
														...
														<div class="profile-info-value">
															<input value="<?php echo $over_all_pros_info_res['overallprosname'] ;?>" type="text" class="form-control" name="prosname" >
														</div>
													</div>
												</div>
											</div>
										...
										<div class="clearfix form-actions">
											<div class="center">
												...
												<a href="assets/redi/require_info.php?over_all_pros_id=<?php echo $over_all_id_pros ?>" class="confirmation">
