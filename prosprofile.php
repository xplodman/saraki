...
<meta http-equiv="refresh" content="900;url=assets/redi/logout.php" />
		...
		<meta charset="utf-8">
		<title>Prosecution profile</title>
					...
					<div class="page-content">
							...
							if (isset($_GET['backresult']))
						{
							...
							if ($backresult ==  "1") {
								...
								$idpros=$_GET['idpros'];
								$result=mysqli_query($sqlcon, "Select pros.prosname,
																...
																From pros
																  ...
																  where `idpros`=$idpros");
								while($prosinfores = mysqli_fetch_assoc($result))
															{	
													?>								
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<div>
									<form method="post" action="assets/redi/editpros.php?idpros=<?php echo $idpros?>" method="post">
										<div id="user-profile-1" class="user-profile row">
											
											<div class="col-xs-12 col-sm-9">
												<div class="profile-user-info profile-user-info-striped">
													<div class="profile-info-row">
														<div class="profile-info-name">Prosecution name</div>

														<div class="profile-info-value">
															<input value="<?php echo $prosinfores['prosname'] ;?>" type="text" class="form-control" name="prosname" >
														</div>
													</div>
												</div>
											</div>
										...
										<div id="user-profile-1" class="user-profile row">
											...
											<div class="col-xs-12 col-sm-9">
												<div class="profile-user-info profile-user-info-striped">
													<div class="profile-info-row">
														<div class="profile-info-name">Overall Prosecution </div>
										...
										<select multiple="multiple" size="10" name="duallistbox_demo1[]" id="form-field-13">
											<?php
												...
												$result_array[] = $row2['iddeparts'];
												?>												
											<option selected value="<?php echo $row2['iddeparts'] ?>"> <?php echo $row2['departname'] ;?> </option>
											<?php } ?>
											...
											<?php
												...
												?>												
											<option value="<?php echo $row99['iddeparts'] ?>"> <?php echo $row99['departname'] ;?> </option>
											<?php } ?>
										</select>
